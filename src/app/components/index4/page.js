...
<>
  ...
  <div
    ...
    id="locationSecondModal"
    tabIndex={-1}
    aria-labelledby="locationSecondModalLabel"
    aria-hidden="true"
  >
      ...
      <div className="modal-content">
        <div className="modal-body">
          <div className="mb-5 d-flex align-items-center justify-content-between">
            <h1 className="modal-title fs-5" id="locationSecondModalLabel">
              Add Your Location
            </h1>
            <button
              type="button"
          ...
          <div className="my-10 text-center">
            <img
              src="../assets/images/svg-graphics/delivery-boy.svg"
              alt=""
              className="img-fluid"
            />
          </div>
  ...
  <main>
    ...
    <section
      ...
      style={{
        background: "url(../assets/images/banner/banner-4.jpg) no-repeat",
              ...
              <div className="card-body p-6">
                <div className="mb-4">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-map-pin text-danger"
                  >
                ...
                <form>
                  <div className="row g-3">
                    <div className="col">
                      <label htmlFor="postcod" className="visually-hidden">
                        Postcode
                      </label>
                      <input
                        type="text"
            ...
            <div>
              ...
              <h3 className="align-items-center d-flex mb-0 h4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="feather feather-layers text-primary"
                >
        ...
        <div className="row g-6">
          <div className="col-12">
            <div className="position-relative">
              <div className="slider-8-columns" id="slider-8-columns">
                {/* item */}
                <div className="item">
                  {/* item */}
                  <Link
                  ...
                  >
                    {/* card */}
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6 text-center">
                        <div className="my-5">
                          <svg
                            width={56}
                            height={56}
                  ...
                  >
                    ...
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6">
                        ...
                        {/* text */}
                        <div className="text-truncate">Dairy</div>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    ...
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6">
                        ...
                        {/* text */}
                        <div className="text-truncate">Vegetables</div>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    ...
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6">
                        ...
                        {/* text */}
                        <div className="text-truncate">Snacks</div>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    ...
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6">
                        ...
                        {/* text */}
                        <div className="text-truncate">Fish</div>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    ...
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6">
                        ...
                        {/* text */}
                        <div className="text-truncate">Pet Foods</div>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    ...
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6">
                        ...
                        {/* text */}
                        <div className="text-truncate">Fruits</div>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    ...
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6">
                        ...
                        {/* text */}
                        <div className="text-truncate">Coffee &amp; Tea</div>
                      </div>
                    </div>
                  </Link>
                </div>
                  ...
                  >
                    ...
                    <div className="card mb-3 card-lift">
                      <div className="card-body text-center py-6">
                        ...
                        {/* text */}
                        <div className="text-truncate">Wine</div>
                      </div>
                    </div>
                  </Link>
                </div>
      ...
      <div className="container">
        ...
        <div className="row align-items-center mb-6">
          ...
          <div className="col-lg-2 col-2">
            <div className="slider-arrow" id="slider-second-arrows" />
          </div>
        </div>
        {/* slider */}
    ...
    <div className="my-lg-14 my-8">
      <div className="container">
        {/* row */}
        <div className="table-responsive-xxl pb-6 pb-xl-0">
          <div className="row flex-nowrap">
            <div className="col">
              <div className="card border-0 card-hover">
                <Link href="#" className="img-zoom">
                  <img
                    src="../assets/images/banner/ad-banner-4.jpg"
                    alt=""
                    className="rounded"
                  />
                </Link>
            ...
            <div className="col">
              <div className="card border-0">
                <Link href="#" className="img-zoom">
                  <img
                    src="../assets/images/banner/ad-banner-5.jpg"
                    alt=""
                    className="rounded"
                  />
                </Link>
            ...
            <div className="col">
              <div className="card border-0">
                <Link href="#" className="img-zoom">
                  <img
                    src="../assets/images/banner/ad-banner-6.jpg"
                    alt=""
                    className="rounded"
                  />
                </Link>
              ...
              <div className="d-flex">
                <div className="mt-1">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="feather feather-shopping-bag text-primary"
                  >
    ...
    <div className="container mb-10">
      <div className="row">
        <div className="col-12 d-grid">
          <Link
            href="#!"
            className="btn btn-soft-warning btn-lg ls-xl text-uppercase rounded-pill"
          >
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-6 col-lg-3 mb-8">
            ...
            <div>
              ...
              <p>
                Praesent vestibulum magna lacinia augue mollisvel aliquet massa
                posuere. Duis et mauris tortor.
              </p>
          ...
          <div className="col-12 col-md-6 col-lg-3 mb-8">
            ...
            <div>
              ...
              <p>
                Aliquam tempus velit augue, sodales tincidunt augue ipsum primis
              ...
              <div>
                <div className="mb-8">
                  ...
                  <svg
                    ...
                    height={34}
                    fill="currentColor"
                    className="bi bi-gift text-primary"
                    viewBox="0 0 16 16"
                  >
              ...
              <div>
                <div className="mb-8">
                  ...
                  <svg
                    ...
                    height={34}
                    fill="currentColor"
                    className="bi bi-tablet text-primary"
                    viewBox="0 0 16 16"
                  >
                ...
                <p className="mb-0">
                  ...
                  <Link href="#">tablet and mobile</Link>. Get live order tracking.
              ...
              <ul className="list-unstyled">
                <li className="mb-2">
                  <Link href="#" className="text-reset">
                    <i className="feather-icon icon-arrow-right me-1" />
                    Adlaj
                  </Link>
                </li>
                <li className="mb-2">
