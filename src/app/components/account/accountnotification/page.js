          ...
          <div className="col-lg-3 col-md-4 col-12 border-end d-none d-md-block">
            <div className="pt-10 pe-lg-10">
              ...
              <ul className="nav flex-column nav-pills nav-pills-dark">
                ...
                {/* nav item */}
                <li className="nav-item">
                  <Link className="nav-link" href="/components/account/accountpayment">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div>
                    ...
                    <p className="mb-0 pe-12">
                      ...
                      malesuada fames ac turpis eguris eu sollicitudin massa.
                      Nulla ipsum odio, aliquam in odio et, fermentum blandit
                      nulla.
                    </p>
                  </div>
                  {/* form checkbox */}
  ...
  >
    ...
    <div className="offcanvas-body">
      <ul className="nav flex-column nav-pills nav-pills-dark">
        ...
        {/* nav item */}
        <li className="nav-item">
          <Link className="nav-link active" href="/components/account/accountnotification">
            <i className="feather-icon icon-bell me-2" />
            Notification
          </Link>
        </li>
