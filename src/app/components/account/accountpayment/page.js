          ...
          <div className="col-lg-3 col-md-4 col-12 border-end d-none d-md-block">
            <div className="pt-10 pe-lg-10">
              ...
              <ul className="nav flex-column nav-pills nav-pills-dark">
                ...
                {/* nav item */}
                <li className="nav-item">
                  <Link className="nav-link" href="/components/account/accountsettings">
                ...
                {/* nav item */}
                <li className="nav-item">
                  <Link className="nav-link" href="/components/account/accountaddress">
                ...
                {/* nav item */}
                <li className="nav-item">
                  <Link className="nav-link" href="/components/account/accountnotification">
  ...
  >
    ...
    <div className="offcanvas-body">
      <ul className="nav flex-column nav-pills nav-pills-dark">
        ...
        {/* nav item */}
        <li className="nav-item">
          <Link className="nav-link active" href="/components/account/accountpayment">
            <i className="feather-icon icon-credit-card me-2" />
            Payment Method
          </Link>
        </li>
        ...
        <div className="modal-body">
          <div>
            ...
            <form className="row mb-4 needs-validation" noValidate="">
              ...
              {/* Month */}
              <div className="mb-3 col-12 col-md-4">
                <label htmlFor="validationCustomMonth" className="form-label">
                  Month
                </label>
                <select
                  className="form-select"
                  id="validationCustomMonth"
                  required=""
                >
              ...
              {/* Year */}
              <div className="mb-3 col-12 col-md-4">
                <label htmlFor="validationCustomYear" className="form-label">
                  Year
                </label>
                <select
                  className="form-select"
                  id="validationCustomYear"
                  required=""
                >
