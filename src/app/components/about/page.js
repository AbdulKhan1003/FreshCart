      ...
      <div className="team-slider mx-4">
        ...
        <div className="item">
          <div className="bg-light rounded">
            ...
            {/* img */}
            <img
              src="/assets/images/about/team-1.png"
              alt=""
              className="img-fluid"
            />
          </div>
        ...
        <div className="item">
          <div className="bg-light rounded">
            ...
            {/* img */}
            <img
              src="/assets/images/about/team-2.png"
              alt=""
              className="img-fluid"
            />
          </div>
        ...
        <div className="item">
          <div className="bg-light rounded">
            ...
            {/* img */}
            <img
              src="/assets/images/about/team-3.png"
              alt=""
              className="img-fluid"
            />
          </div>
        ...
        <div className="item">
          <div className="bg-light rounded">
            ...
            {/* img */}
            <img
              src="/assets/images/about/team-4.png"
              alt=""
              className="img-fluid"
            />
          </div>
        ...
        <div className="item">
          <div className="bg-light rounded">
            ...
            {/* img */}
            <img
              src="/assets/images/about/team-5.png"
              alt=""
              className="img-fluid"
            />
          </div>
